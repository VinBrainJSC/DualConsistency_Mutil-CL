...
class kiunet(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder1 = nn.Conv2d(2, 16, 3, stride=1, padding=1)  # First Layer GrayScale Image , change to input channels to 3 in case of RGB 
        ...
        self.encoderf1 =   nn.Conv2d(2, 16, 3, stride=1, padding=1)  # First Layer GrayScale Image , change to input channels to 3 in case of RGB 
...
class densekiunet(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder1 = nn.Conv2d(2, 16, 3, stride=1, padding=1) 
        ...
        self.encoderf1 =   nn.Conv2d(2, 16, 3, stride=1, padding=1)
