...
#     print('Y ',ymin - 5,ymin + 315)
    ...
    if npy_data_aftercrop.shape[1] != 320 or npy_data_aftercrop.shape[2] != 320:
        raise Exception('The shapes do not meet the requirement')
...
#     val_img_path = ['/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_030.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_061.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_173.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_174.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_233.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_258.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_269.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_282.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_309.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_321.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_397.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_423.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_431.nii.gz',
#                     '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/hepaticvessel_437.nii.gz']
    for case in val_img_path:
        ...
        if os.path.exists(liver_msk_path):
            ...
            sitk.WriteImage(img_itk, '../../data/MSD_NEW/image_ROI/image_{}.nii.gz'.format(str(idx)))
            ...
            sitk.WriteImage(vessel_label_itk,
                            '../../data/MSD_NEW/label_vessel_ROI/image_{}_gt.nii.gz'.format(str(idx)))
...
def ROI_crop_preprocess_M(val_img_Dir, msk_baseDir, vessel_msk1_baseDir, organ='ROI'):
    val_img_path = sorted(glob.glob(val_img_Dir))
    for case in val_img_path:
        print(case)
        img_itk = sitk.ReadImage(case)
        ...
        if os.path.exists(liver_msk_path):
            ...
            vessel_label_itk.SetSpacing(spacing)
            vessel_label_itk.SetDirection(direction)
            sitk.WriteImage(img_itk, '../../data/MSD_NEW_M/image_ROI/image_{}.nii.gz'.format(str(idx)))
            # sitk.WriteImage(label_itk,
            #                 '/home/xuzhe/Segment/SSL4MIS/data/IRCAD/label_ROI_{}/image_{}_gt.nii.gz'.format(mode, str(idx)[1:]))
            sitk.WriteImage(vessel_label_itk,
                            '../../data/MSD_NEW_M/label_vessel_ROI/image_{}_gt.nii.gz'.format(str(idx)))
    print("Converted MSD volumes to Mei_ROI")
...
if __name__ == '__main__':
    ...
    train_img_Dir = '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr/*.nii.gz'

    # liver
    ROI_baseDir = '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/imagesTr_liver'
    vessel_msk1_baseDir = '/workspace/vinbrain/namnguyen/arterial_liver_segmentation/dataset/hepatic_vessel_MSD/labelsTr/'

#     ROI_crop_preprocess(train_img_Dir, ROI_baseDir, vessel_msk1_baseDir)

    ROI_crop_preprocess_M(train_img_Dir, ROI_baseDir, vessel_msk1_baseDir)
