...
#             print('-----------', idx)
            sitk.WriteImage(img_itk, '../../data/MSD_c/image_ROI_ori/image_{}.nii.gz'.format(str(idx)))
            sitk.WriteImage(vessel_label_itk,
                            '../../data/MSD_c/label_vessel_ROI/image_{}_gt.nii.gz'.format(str(idx)))
